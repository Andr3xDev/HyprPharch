...
vim.opt.inccommand = "split" -- preview :%s/.../.../ before confirming (default: '')
vim.opt.laststatus = 3 -- Global statusline (default: 2)
vim.opt.smoothscroll = true -- Smooth scrolling (default: false)
